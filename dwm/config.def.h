...
static const char *fonts[]          = { "Quicksand:size=12","Noto Sans JP:size=10","SauceCodePro Nerd Font Mono:size=20","Material Icons:pixelsize=15;5","SHINJI BLUES:pixelsize=15;5","Togalite medium:pixelsize=12;4"};
...
static const char *slleep[]  = {"suspend"};
static const char *shut[] = {"poweroff", ">", "/home/granted/Desktop/lol.txt", "2>&1"};
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_Escape, spawn,          {.v = shut} },
	{ MODKEY,                       XK_Print,  spawn,          {.v = slleep} },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
